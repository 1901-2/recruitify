...
const Footer = () => {
    return (
        <div className='foooter p-[5rem] bg-blueColor rounded-[10px] gap-8 grid 
        grid-cols-5 auto items-center justify-center'>
      
      <div>
        <div className='logoDiv'>
            <h1 className="logo text-[25px] text-white pb-[1.5rem]">
                <strong>Recrutify</strong>
                </h1>
        </div>
