...
const Value = () => {
    return (
     ...
     <img src={shield} alt=""  className='w-[70%]' />
      ...
      <p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
        We believe in making things better for everyone, evenn if just by a little bit!
      </p>
       </div>
     ...
     <img src={valentines} alt=""  className='w-[70%]' />
      ...
      <p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
      We work on the basis of creating trust which can be nurtured through authenticity and 
      transparency
      </p>
       </div>
       ...
       <div className="card mt-[2rem] flex justify-between bg-blueColor p-[5rem] rounded-[10px] ">
        ...
        <div>
            <h1 className='text-blueColor text-[30px] font-bold'>Transforming Resumes into Opportunities </h1>
            <h2 className='text-textColor text-[20px] font-bold'>Let's get started </h2>
        </div>
